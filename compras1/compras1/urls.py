...
urlpatterns = [
    ...
    #path('reportesConsultaTraeExcel/<str:username>, <str:sedeSeleccionada>,<str:nombreUsuario>, <str:nombreSede>,<str:perfil>,<str:numeroReporte>/', PostStoreReportesConsulta.as_view(), name='post_storeReportesConsulta'),
    ## Fin reportes

    path('contrasena/', views.Contrasena.as_view(), name='contrasena'),
    path('contrasena/<str:username>,<str:sedeSeleccionada>,<str:nombreUsuario>,<str:nombreSede>,<str:perfil>', views.Contrasena.as_view(), name='contrasena'),
...
# Añadir
admin.site.site_header = 'Administracion Medical Compras Pruebas'
admin.site.site_title = "Portal de Medical Compras Pruebas"
admin.site.index_title = "Bienvenidos al portal de administración Medical Compras Pruebas"
